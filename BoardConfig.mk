...
USE_OPENGL_RENDERER := true
BOARD_EGL_CFG := device/moto/sholes/egl.cfg
...
TARGET_PREBUILT_KERNEL := device/moto/sholes/kernel
TARGET_PREBUILT_RECOVERY_KERNEL := device/moto/sholes/recovery_kernel
